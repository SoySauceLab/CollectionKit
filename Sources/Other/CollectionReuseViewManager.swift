...
public class CollectionReuseViewManager: NSObject {
  ...
  public var dequeueOverridenIdentifier: String?
  public var isReuseActive: Bool = true
  ...
  public func dequeue<T: UIView> (_ defaultView: @autoclosure () -> T) -> T {
    let identifier = dequeueOverridenIdentifier ?? NSStringFromClass(T.self)
